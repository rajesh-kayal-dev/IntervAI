...
import { createSession, chatWithInterviewer, finishSimulation, getSimulationResult, transcribeAudio, getZegoCredentials, updateLiveNotes } from "../controllers/simulationController.js";
...
router.post("/update-notes", protect, updateLiveNotes);
