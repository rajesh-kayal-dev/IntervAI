    ...
    <div className='flex justify-center items-center min-h-[95vh] px-4 sm:px-6 py-16 mt-12'>
      <div className='w-full max-w-md bg-white rounded-3xl border border-gray-200 shadow-2xl p-8 sm:p-10 relative overflow-hidden transition-all duration-350'>
        <div className='text-center mb-6'>
          <h2 className='font-playfair text-3xl font-semibold text-[#111827] tracking-tight'>Welcome Back</h2>
          <p className='text-gray-500 text-sm mt-2 font-light'>
            Sign in to continue to IntervAI
          </p>
        </div>
        ...
        <div className="flex items-center gap-4 my-6">
          ...
          <span className="text-gray-400 text-[10px] font-semibold uppercase font-mono">or</span>
          <div className="flex-1 h-[1px] bg-gray-200"></div>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-gray-500 font-light">
          New here? <Link to="/register" className="text-[#1B6C42] font-semibold hover:underline">Create an account</Link>
        </p>
      </div>
    </div>
